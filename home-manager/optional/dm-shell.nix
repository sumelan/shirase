{
  ...
  imports = [inputs.dm-shell.homeModules.dankMaterialShell];

  options.custom = {
    dm-shell.enable = lib.mkEnableOption "Quickshell for niri";
  };

  config = lib.mkIf config.custom.dm-shell.enable {
