...
}:
{
  options.custom = with lib; {
    wallpapers = mkOption {
      ...
      default =
        if isLaptop then [ "/home/${user}/wallpapers/eDP-1.png" ]
      else [ 
        "/home/${user}/wallpapers/HDMI-A-1.png"
        "/home/${user}/wallpapers/DP-1.png"
      ];
    };
  };
    ...
    goNord =
      pkgs.writers.writePython3Bin "goNord" {
        ...
        in
          ...
          generatedWallpapers = builtins.mapAttrs generateWallpaper (config.custom.wallpapers);
